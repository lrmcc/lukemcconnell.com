...
function SpeechBubble() {
    // Manual speech lines
    ctx.lineWidth = 12;
    ctx.strokeStyle = 'rgba(150, 31, 24, 1)';
    let start = { x: 1100,    y: 80  };
    let cp1 =   { x: 1100,   y: 60  };
    let cp2 =   { x: 1120,   y: 60  };
    let end =   { x: 1120,   y: 60 };
    ...
    ctx.lineTo(1250, 60);
    // top right corner
    ctx.bezierCurveTo(1250, 60, 1300, 60, 1300, 100);
    // right line
    ctx.lineTo(1300, 230);
    // bottom right corner
    ctx.bezierCurveTo(1300, 250, 1280, 250, 1280, 250);
    // bottom line - right side
    ctx.lineTo(1200, 250);
    // right side speech line
    ctx.lineTo(1160, 280);
    // right side speech line
    ctx.lineTo(1140, 250);
    ...
    ctx.lineTo(1120, 250);
    // bottom left corner
    ctx.bezierCurveTo(1120, 250, 1100, 250, 1100, 230);
    // left side line
    ctx.lineTo(1100, 80);
    ctx.stroke();
}
...
function Fuji(moveToX, moveToY, lineToX, lineToY, lineCap, lineWidth, strokeStyle) {
    ...
    this.draw = function() {
        ctx.beginPath();
        ctx.rect(this.lineToX - iconWidth*0.022, this.lineToY - iconHeight[2]*0.01, iconWidth*0.29, iconHeight[2]*0.19);
        ...
        ctx.moveTo(this.lineToX - (iconHeight[2] * 0.02), this.lineToY + (iconHeight[2] * 0.16));
        ctx.lineTo(this.lineToX + (iconHeight[2] * 0.04), this.lineToY + (iconHeight[2] * 0.2));
        ctx.lineTo(this.lineToX + (iconHeight[2] * 0.09), this.lineToY + (iconHeight[2] * 0.16));
        ctx.lineTo(this.lineToX + (iconHeight[2] * 0.15), this.lineToY + (iconHeight[2] * 0.2));
        ctx.lineTo(this.lineToX + (iconHeight[2] * 0.20), this.lineToY + (iconHeight[2] * 0.16));
        ctx.lineTo(this.lineToX + (iconHeight[2] * 0.27), this.lineToY + (iconHeight[2] * 0.2));
        ctx.stroke();
 ...
 function Sun(x, y, offset, radius, minRadius) {
    ...
    this.dr = -((this.radius + this.minRadius) / (iconWidth * 29.75));
    this.dcolor = 1;
    ...
    this.update = function() {
        ...
        if (Date.now() - this.timer > (iconWidth * 0.5)) {
...
function Pencil(moveToX, moveToY, lineWidth, strokeStyle) {
    ...
    this.draw = function() {
        ...
        ctx.lineTo(xPos[1] + (iconWidth * 0.78), yPos[1] + (iconHeight[1] * 0.68));
        ctx.stroke();
...
const contentSizing = () => {
    if (mobileOrTablet) mobileContentSizing();
